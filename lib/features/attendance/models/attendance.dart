...
class Attendance {
  ...
  Color get statusColor {
    switch (status) {
      case 'present':
        return const Color(0xFF7ED321); // أخضر فاتح
      case 'absent':
        return const Color(0xFFF8E71C); // أصفر فاتح
      case 'excused':
        return const Color(0xFF50A6E3); // أزرق فاتح
      case 'late':
        return const Color(0xFFF5A623); // برتقالي
      case 'sick':
